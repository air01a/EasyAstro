...
//image.data = I16_BITS_MAX_VALUE * image.data ** (1 / midtones) / I16_BITS_MAX_VALUE ** (1 / midtones)
  ...
  static int _adjustLevel(int value, int white, int black, int midtones) {
    ...
    //I16_BITS_MAX_VALUE * image.data ** (1 / midtones) / I16_BITS_MAX_VALUE ** (1 / midtones)
   
  //  int v = (65535 * pow(value, (1/midtones)) / (pow(65535,1/midtones))).toInt().clamp(black,white);
   // return (v*(white - black)/255).toInt();
  }
//image.data = I16_BITS_MAX_VALUE * image.data ** (1 / midtones) / I16_BITS_MAX_VALUE ** (1 / midtones)
